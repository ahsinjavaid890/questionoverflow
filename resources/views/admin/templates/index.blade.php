...
@section('title','All Templates Categories')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">All Templates Categories</li>
                    </ol>
                </div>
                <h4 class="page-title">All Templates Categories</h4>
            </div>
        </div>
    </div>
                    ...
                    <table id="basic-datatable" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $r->name }}</td>
                                <td>{{ $r->status }}</td>
                                <td>{{ DB::table('templates')->where('category_id' , $r->id)->count() }}</td>
