...
<div class="container-fluid">
    ...
    <!-- end page title -->
    @include('admin.alert')
<form enctype="multipart/form-data" method="POST" action="{{ url('admin/tutorials/updatecategory') }}" class="needs-validation" novalidate>
        {{ csrf_field() }}
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input onkeyup="createslug(this.value)" value="{{ $data->name }}" type="text" class="form-control" name="name" id="validationCustom01"
                            placeholder="Title" required>
                    </div>
                    <div class="form-group mb-2">
                        <label for="validationCustom02">Slug</label>
                        <input type="text" value="{{ $data->url }}" id="slug" class="form-control" name="slug" onkeyup="checkslug()" required >
