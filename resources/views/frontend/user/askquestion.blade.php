                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="generic-popover d-none">
                                    ...
                                    <ul class="generic-list-item generic-list-item-bullet">
                                        ...
                                        <li class="lh-18 text-black-50">Include tags that are crucial to your question only, like
                                            <div class="tag-link">c#</div>
                                        </li>
                                        <li class="lh-18 text-black-50">Only include version numbers, like
                                            <div class="tag-link">c#-4.0</div>, when absolutely necessary</li>
                                    ...
                                    <p class="fs-14 text-black-50"><a href="#" class="text-color hover-underline" target="_blank">Create new tags</a> or post without it and <a href="#" class="text-color hover-underline" target="_blank">ask the community</a> to create one for you.
                                    </p>
                                </div>
                                <!-- end generic-popover -->
                            </div>
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion-two">
                                <div class="card-body">
                                    <p class="fs-14 lh-22 text-black-50 pb-2">
                                        <a class="text-color hover-underline d-block" href="#" target="_blank">Super user</a> Troubleshooting hardware and software issues
                                    </p>
                                    <p class="fs-14 lh-22 text-black-50 pb-2">
                                        <a class="text-color hover-underline d-block" href="#" target="_blank">Software engineering</a> For software development methods and process questions
                                    </p>
                                    <p class="fs-14 lh-22 text-black-50 pb-2">
