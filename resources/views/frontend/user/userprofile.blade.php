...
<meta name="DC.Title" content="Profile | {{ $data->name }}">
...
@section('content')
@php
    $questions = DB::table('answerquestions')->where('question_auther' , $data->username)->count();
    $answers = DB::table('onlyanswers')->where('users' , $data->id)->count();
@endphp
                ...
                <div class="hero-content">
                    <div class="media media-card align-items-center shadow-none p-0 mb-0 rounded-0 bg-transparent">
                        <div class="media-img media--img">
                            ...
                            <img src="{{ url('images') }}/{{ $data->profileimage }}" alt="avatar">
                            @else
                        ...
                        <div class="media-body">
                            ...
                            <small class="meta d-block lh-20 pb-2">
                                <span>Member since {{ Cmf::create_time_ago($data->created_at) }}</span>
                            </small>
                            <div class="stats fs-14 fw-medium d-flex align-items-center lh-18">
                                @if($questions > 0)
                                <span class="text-black pr-2" title="Reputation">{{ $questions }}</span>
                                @endif
                                @if($answers > 0)
                                <span class="pr-2 d-inline-flex align-items-center" title="Gold"><span class="ball ml-1 gold"></span>{{ $answers }}</span>
                                @endif
                            </div>
                        </div>
                    </div><!-- end media -->
            ...
            <div class="col-lg-4">
                @if(Auth::check())
                    ...
                    <div class="hero-btn-box text-right py-3">
                        <a href="{{ url('profile-settings') }}" class="btn theme-btn theme-btn-outline theme-btn-outline-gray"><i class="la la-gear mr-1"></i> Edit Profile</a>
                    </div>
                    @endif
                @endif
            </div><!-- end col-lg-4 -->
        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show" id="user-profile" role="tabpanel" aria-labelledby="user-profile-tab">
                        <div class="user-panel-main-bar">
                            ...
                            <div class="user-panel mb-30px pt-30px border-top border-top-gray">
                                <ul class="generic-list-item generic-list-item-bullet">
                                    @if($data->website)
                                    <li class="pl-3"><a href="{{$data->website}}" class="d-inline-block">Website</a></li>
                                    @endif
                                    @if($data->facebook)
                                    <li class="pl-3"><a href="{{$data->facebook}}" class="d-inline-block">Facebook</a></li>
                                    @endif
                                    @if($data->twitter)
                                    <li class="pl-3"><a href="{{$data->twitter}}" class="d-inline-block">Twitter</a></li>
                                    @endif
                                    @if($data->instagram)
                                    <li class="pl-3"><a href="{{$data->instagram}}" class="d-inline-block">Instagram</a></li>
                                    @endif
                                </ul>
                            </div><!-- end user-panel -->
                            <div class="user-panel mb-30px">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 responsive-column-half">
                                        <div class="media media-card align-items-center shadow-none border border-gray p-3">
                                            ...
                                            <div class="media-body">
                                                <h5 class="fw-medium">{{ $questions }}</h5>
                            ...
                            <div class="user-panel mb-30px">
                                <div class="bg-gray p-3 rounded-rounded d-flex align-items-center justify-content-between">
                                    <h3 class="fs-17">Top posts <span>({{$questions}})</span></h3>
                                </div>
