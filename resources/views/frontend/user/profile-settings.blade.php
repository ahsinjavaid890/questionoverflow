...
@section('title')
<title>Profile Settings | {{ $data->name }}</title>
<meta name="DC.Title" content="Profile Settings | {{ $data->name }}">
                    ...
                    <div class="tab-pane fade show active" id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
                        <div class="user-panel-main-bar">
                            <div class="user-panel">
                                ...
                                <form enctype="multipart/form-data" action="{{ url('updateuserprofile') }}" method="post" class="pt-35px MultiFile-intercepted">
                                    @csrf
                                        ...
                                        <div class="row pt-4 align-items-center">
                                            <div class="col-lg-6">
                                                <div class="edit-profile-photo d-flex flex-wrap align-items-center">
                                                    ...
                                                    <img src="{{ url('images') }}/{{ $data->profileimage }}" alt="user avatar" class="profile-img mr-4">
                                                    @else
                                                    <img src="https://cdn-icons-png.flaticon.com/512/149/149071.png" alt="user avatar" class="profile-img mr-4">
                                                    @endif
                                                    <div>
                                                        <div class="file-upload-wrap file--upload-wrap">
                                                            <div class="MultiFile-wrap" id="MultiFile1"><input type="file" name="profileimage" class="multi file-upload-input MultiFile-applied" id="MultiFile1" value=""><div class="MultiFile-list" id="MultiFile1_list"></div></div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        <input class="form-control form--control" type="text" name="name" value="{{ $data->name }}">
                                                    </div>
                                                </div>
                                                <div class="input-box">
                                                    <label class="fs-13 text-black lh-20 fw-medium">Country</label>
                                                    <div class="form-group">
                                                        <input class="form-control form--control" type="text" name="country" value="{{ $data->country }}">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-6 -->
                                            <div class="col-lg-12">
                                                <div class="input-box">
                                                    ...
                                                    <textarea class="form-control" rows="8" name="about">{{ $data->about }}</textarea>
                                                </div>
                                            </div><!-- end col-lg-12 -->
                                        </div><!-- end row -->
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-lg-6">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        <input value="{{ $data->website }}" class="form-control form--control pl-40px" type="text" name="website">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        <input value="{{ $data->twitter }}" class="form-control form--control pl-40px" type="text" name="twitter">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        <input value="{{ $data->facebook }}" class="form-control form--control pl-40px" type="text" name="facebook">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        <input value="{{ $data->instagram }}" class="form-control form--control pl-40px" type="text" name="instagram">
                    ...
                    <div class="tab-pane fade" id="change-password" role="tabpanel" aria-labelledby="change-password-tab">
                        <div class="user-panel-main-bar">
                            <div class="user-panel">
                                ...
                                <form method="post" class="pt-20px MultiFile-intercepted">
                                    <div class="settings-item mb-30px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button class="btn theme-btn-outline theme-btn-outline-gray toggle-password" type="button" data-toggle="tooltip" data-placement="right" title="" data-original-title="Show/hide password">
