...
<head>
  ...
  <link href="{{ asset('public/admin/app-modern.min.css') }}" rel="stylesheet" />
  <link href="{{ asset('public/admin/app-modern-dark.min.css') }}" rel="stylesheet" />
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.js"></script>
  ...
  <script src="{{ url('public/admin/js/charCount.js') }}"></script>
